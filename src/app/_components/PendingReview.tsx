...
import type { PendingDocView } from "../../repo/queries";
 ...
 */
export function PendingReview({ pending }: { pending: PendingDocView[] }) {
  ...
  return (
    <section className="pending" aria-label="후보 확인 필요">
      ...
      <p className="col-desc">
        이수증의 이름과 맞는 이수 대기 건이 여럿이라 자동으로 붙이지 않았습니다. 어느 건인지 골라 주세요.
      </p>
